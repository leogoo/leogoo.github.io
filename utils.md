# Adapter
- [ary](#ary)
- [collectInto:传入数组参数](#collectInto)

### Adapter
1. <div id="ary">ary:忽略多余的参数</div>
    ```
...
1. over
    ...
    ```
1. pipeFunctions: Performs left-to-right function composition
    ```
...
1. deepFlatten
    ...
    ```
1. difference: 返回第一个数组中不在第二个数组的元素
    ```
